...
if uploaded_file is not None:
    try:
        ...
        # --- TEXT-BASED HEADER MATCHING ENGINE ---
        # Cleans header spaces and case variance to find columns by name, not by position
        ...
        # Dynamically locate the status column containing "MOVE TO QC" text strings
        status_col = None
        ...
        # Check if all 5 mandatory column headers + status columns are verified
